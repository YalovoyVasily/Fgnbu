...
namespace Fgnbu
{
    public partial class SposobPrim : Form
    {
        public SposobPrim()
        {
            InitializeComponent();
        ...
        {
            Table_Class table = new Table_Class(DBConnection.qrSposobPrim);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "insert into [dbo].[SposobPrim] ( [SposobPrim_Title]) values ('" + tbTitle.Text + "')";
        ...
        {
            SqlCommand command = new SqlCommand("", DBConnection.connection);
            command.CommandText = "update [dbo].[SposobPrim] set " +
            "[SposobPrim_Title] ='" + tbTitle.Text + "'" +
            " where ID_SposobPrim = " + DBConnection.IDrecord + "";
            DBConnection.connection.Open();
            command.ExecuteNonQuery();
            DBConnection.connection.Close();
            Bolezn_Load(sender, e);
        ...
        {
            SqlCommand command = new SqlCommand("", DBConnection.connection);
            command.CommandText = "delete from [dbo].[SposobPrim]" +
                "where ID_SposobPrim =" + DBConnection.IDrecord + "";
            DBConnection.connection.Open();
            command.ExecuteNonQuery();
            DBConnection.connection.Close();
        ...
        private void chkFilter_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                case (true):
                    Table_Class table1 = new Table_Class(DBConnection.qrTip + string.Format("where [SposobPrim_Title] like '%{0}%' ", tbSearch.Text));
