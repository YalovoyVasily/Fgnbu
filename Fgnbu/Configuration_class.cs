...
namespace Fgnbu
{
    public class Configuration_class
    {
        ...
        public void SQL_Server_Configuration_Get()
        {
            ...
            RegistryKey key = registry.CreateSubKey("Server_Configuration_Fgnbu");
            try
            {
        ...
        public void SQL_Data_Base_Collection()
        {
            ...
            SqlCommand command = new SqlCommand("select name from sys.databases " +
                ...
                "and name like 'Vakts%'", connection);
        ...
        public static string Organization_Name = "Fgnbu", 
        ...
        public void Document_Configuration_Get()
        {
            ...
            RegistryKey key 
                = registry.
                CreateSubKey("Server_Configuration_Fgnbu");
            try
            {
                Organization_Name 
